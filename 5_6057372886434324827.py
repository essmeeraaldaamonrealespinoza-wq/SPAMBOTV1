...
OWNER_TG_ID = int(os.environ.get('7731577454'))
BOT_TOKEN = os.environ.get('8785768229:AAFjMo3w6X0fw_68zmS0mOk78lZlxRjeOgM')
...
🚀 Welcome to Spyther's Spam Bot  

💡 Type /help to explore all commands  
🔐 Secure • Fast • Multi-Account Ready  
...
✨ 𝗕𝗔𝗦𝗜𝗖  
┃ /help 🆘 → Show this menu  
┃ /usg 📊 → System usage stats  

━━━━━━━━━━━━━━━━━━━━  

🔐 𝗟𝗢𝗚𝗜𝗡 𝗠𝗘𝗧𝗛𝗢𝗗𝗦  
┃ /login 📱 → Normal login  
┃ /plogin 🌐 → Browser login  
┃ /slogin 🔑 → Session ID login  
┃ /psid 🗝️ → Browser session ID  

━━━━━━━━━━━━━━━━━━━━  

👤 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 𝗠𝗔𝗡𝗔𝗚𝗘𝗠𝗘𝗡𝗧  
┃ /viewmyac 👀 → View accounts  
┃ /setig 🔄 <number> → Set default  
...
🔄 𝗥𝗢𝗧𝗔𝗧𝗜𝗢𝗡 & 𝗦𝗘𝗧𝗨𝗣  
┃ /pair 📦 ig1-ig2 → Pair accounts  
┃ /unpair ✨ → Remove pairing  
┃ /switch ⏱️ <min> → Switch interval  
┃ /threads 🔢 <1-5> → Set threads  
┃ /viewpref ⚙️ → Preferences  

━━━━━━━━━━━━━━━━━━━━  

💥 𝗔𝗖𝗧𝗜𝗢𝗡𝗦  
┃ /attack 💣 → Start attack  
┃ /pattack 🚀 → Manual attack  
...
👑 𝗔𝗗𝗠𝗜𝗡 𝗖𝗢𝗡𝗧𝗥𝗢𝗟𝗦  
┃ /add ➕ <tg_id> → Add user  
┃ /remove ➖ <tg_id> → Remove user  
┃ /users 📜 → List users  
┃ /flush 🧹 → Stop all tasks  
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not is_authorized(user_id):
        await update.message.reply_text(
            "⚠️ You are not authorised to use this bot.\nContact owner: @spyther ⚠️"
        )
        return
